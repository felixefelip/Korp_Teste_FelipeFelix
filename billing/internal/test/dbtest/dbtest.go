...
func Setup() (*gorm.DB, error) {
	...
	if err := connection.AutoMigrate(&model.Product{}, &model.Invoice{}, &model.InvoiceItem{}); err != nil {
...
func Reset(t testing.TB, connection *gorm.DB) {
	...
	err := connection.
		Exec("TRUNCATE TABLE invoice, invoice_item, product RESTART IDENTITY CASCADE").Error
